...
use aion_system::prelude::{StoredSystemKind, StoredSystemMetadata, SystemError, SystemResult};


pub type SyncJoinHandles = Vec<JoinHandle<(ProgramId, StoredSystemMetadata, StoredSystemKind, Result<Option<SystemResult>, SystemError>)>>;
pub type AsyncJoinHandles = Vec<tokio::task::JoinHandle<(ProgramId, StoredSystemMetadata, StoredSystemKind, Result<Option<SystemResult>, SystemError>)>>;
